...
def calculate_roc(thresholds,
    ...
    # plot_roc_custom(fprs[4], tprs[4], '/mckim/temp/plot3.png', use_log_scale=True)
    # plot_roc_custom(fprs[4], tprs[4], '/mckim/temp/plot4.png', use_log_scale=False)
    # plot_roc_custom(fprs[4], tprs[4], '/mckim/temp/plot3.pdf', use_log_scale=True)
    # plot_roc_custom(fprs[4], tprs[4], '/mckim/temp/plot4.pdf', use_log_scale=False)
...
def plot_roc_custom(fprs, tprs, save_path, figsize=(6, 3), use_log_scale=True):
    ...
    if use_log_scale:
        ax.set_title("Receiver Operating Characteristic on LFW Dataset (Log Scale)")
        ax.set_xscale('log')
    ...
    plt.plot(fprs, tprs, color='blue', lw=1, label='ROC curve ViT (WebFace4M)')
