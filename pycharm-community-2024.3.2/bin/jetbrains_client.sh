...
if [ -z "$JRE" ] && [ -s "${CONFIG_HOME}/JetBrains/PyCharmCE2024.3/jetbrains_client.jdk" ]; then
  USER_JRE=$(cat "${CONFIG_HOME}/JetBrains/PyCharmCE2024.3/jetbrains_client.jdk")
...
if [ -n "$JETBRAINS_CLIENT_VM_OPTIONS" ] && [ -r "$JETBRAINS_CLIENT_VM_OPTIONS" ]; then
  USER_VM_OPTIONS_FILE="$JETBRAINS_CLIENT_VM_OPTIONS"
elif [ -r "${IDE_HOME}.vmoptions" ]; then
  USER_VM_OPTIONS_FILE="${IDE_HOME}.vmoptions"
elif [ -r "${CONFIG_HOME}/JetBrains/PyCharmCE2024.3/jetbrains_client64.vmoptions" ]; then
  USER_VM_OPTIONS_FILE="${CONFIG_HOME}/JetBrains/PyCharmCE2024.3/jetbrains_client64.vmoptions"
fi
