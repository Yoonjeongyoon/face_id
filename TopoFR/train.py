...
#병렬 학습
    ...
    if rank == 0:
        ...
        convert_onnx(backbone.cpu().eval(), path_module, os.path.join(cfg.output, "model.onnx"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, help="py config file", default='configs/ms1mv2_r100.py')
