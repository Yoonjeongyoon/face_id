...
if __name__ == '__main__':
    ...
    log_file = os.path.join(os.path.dirname(__file__), 'benchmark_results.txt')
    # 콘솔과 파일에 동시 출력하도록 설정
    ...
    # resnet = get_model(args.network, dropout=0, fp16=False, num_features=cfg.embedding_size, num_classes=cfg.num_classes)
    ...
    for model_path in model_paths:
        ...
        embeddings_dict = get_embeddings_from_pathlist(path_list, batch_size=256)
